...
console.log(firstName.includes("Par"));
console.log(firstName.startsWith("Par"));
console.log(firstName.endsWith("Par"));
console.log(firstName[0]);
let anotherName = firstName.replace("Part", "khu") + "i";
...
arr.push(10);
arr.unshift(0);
arr.splice(4, 0, "Parth"); //index numberOfDeletedElements ValueInserted
...
course = courses.find(course => course.NAme === "Parth");
console.log(course);
